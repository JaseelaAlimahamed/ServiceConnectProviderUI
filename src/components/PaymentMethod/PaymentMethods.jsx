...
PaymentMethods = () => {
  ...
  return (
    <div className="min-h-screen bg-light-gray flex items-center justify-center flex-col relative">
      ...
      {/* Payment Section */}
      <div className="w-[360px] md:w-[500px] lg:w-[700px] h-[134px] rounded-lg bg-white shadow-md flex justify-center md:justify-evenly items-center space-x-2">
        <div>
      ...
      <div className="mt-2">
        {/* Map through the payment methods */}
        {paymentData.methods.map((method) => (
          <div
            key={method.id}
            className="w-[360px] md:w-[500px] lg:w-[700px] h-[60px] bg-white flex justify-end items-center rounded-lg shadow-md mb-2"
          >
        ...
        <div className="w-[360px] md:w-[500px] lg:w-[700px] h-[62px] flex justify-end mt-9">
