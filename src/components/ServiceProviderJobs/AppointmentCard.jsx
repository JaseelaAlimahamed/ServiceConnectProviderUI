...
const AppointmentCard = ({ appointments,}) => {
  return (
    <div  className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-8 p-4" >
      {appointments.map((appointment, index) => (
    <div key={index}
     className="flex mx-auto h-auto w-full bg-primary shadow-lg rounded-2xl overflow-hidden relative mb-4" 
    style={{  fontFamily: 'Poppins, sans-serif' }} >
           <div
            className={`w-3 sm:w-3 md:w-3 lg:w-3 xl:w-3 ${
