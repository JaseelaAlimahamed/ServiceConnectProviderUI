  ...
  return (
    <div className="flex flex-col">
      <div className="relative">
        ...
        <input
          className={`px-4 py-2 mt-1 rounded-md border border-light-gray bg-medium-gray font-input text-dark-gray focus:outline-none focus:ring-2 focus:ring-secondary ${
            icon ? "pl-10" : ""
          }`}
          style={{
            width: inputWidth,
