...
const ButtonComponentWithoutArrow = ({ label, type = "button", disabled = false, isActive, btnWidth, btnHeight,onClick }) => {
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`rounded-full border-[1px] border-black font-medium transition-all duration-300 disabled:opacity-50 flex items-center justify-center h-10 w-20 md:w-24 lg:w-32 xl:w-48 ${
