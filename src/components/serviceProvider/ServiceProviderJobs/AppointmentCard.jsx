  ...
  return (
    <div>
      {appointments.map((appointment, index) => (
        <div key={index} className="flex max-w-sm mx-auto bg-white shadow-lg rounded-2xl overflow-hidden relative mb-4">
           <div
            className={`w-3 ${
          ...
          <div className="p-4 flex-1 flex flex-col">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-semibold text-[#303972]">{appointment.title}</h2>
              <a href={appointment.viewLink} className="text-sm hover:underline mr-4">View</a>
            </div>
