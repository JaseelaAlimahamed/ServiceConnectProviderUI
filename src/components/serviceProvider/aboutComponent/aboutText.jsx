  ...
  return (
    <div className="w-full h-screen p-4 bg-primary ">
      <div className="max-w-4xl mx-auto">
        ...
        <section className='mt-8'>
          <h2 className="md:text-base lg:text-lg  mb-4 text-heading_blck font-bold">Vission</h2>
          <p className="md:text-base lg:text-lg text-para_grey font-medium">
            Ut proverbia non nulla veriora sint quam vestra dogmata. Tamen aberramus a proposito, 
            et, ne longius, prorsus, inquam, Piso, si ista mala sunt, placet. Omnes enim iucundum 
            motum, quo sensus hilaretur.
          </p>
          <p className="md:text-base lg:text-lg mt-4 text-para_grey font-medium">
            Dicam, inquam, et quidem discendi causa magis, quam quo te aut Epicurum reprehensum 
            velim. Dolor ergo, id est summum malum, metuetur semper, etiamsi non aderit.
          </p>
        </section>
      </div>
    </div>
