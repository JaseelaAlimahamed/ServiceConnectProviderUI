      ...
      <div className="mt-6">
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex justify-between items-center">
            ...
            <Link to="/recent-activity" className="text-sm text-customPurple">
              See more
            </Link>
          </div>
      ...
      <div className="mt-6">
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex justify-between items-center">
            ...
            <Link to="/active-services" className="text-sm text-customPurple">
              See more
            </Link>
          </div>
      ...
      <div className="mt-6">
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex justify-between items-center">
            ...
            <Link to="/bookings" className="text-sm text-customPurple">
              See more
            </Link>
          </div>
          {services.map((service, index) => (
      ...
      <div className="mt-6">
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex justify-between items-center">
            ...
            <Link to="/requests" className="text-sm text-customPurple">
              See more
            </Link>
          </div>
          {services.map((service, index) => (
