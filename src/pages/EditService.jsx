  ...
  return (
    <div className="flex  bg-[#D9D9DB] overflow-auto">
      <div className="flex flex-col items-center p-6 bg-[#D9D9DB] rounded-md md:shadow-lg w-screen min-h-screen justify-center overflow-auto">
        <Formik
          initialValues={{
            status: "Active", // Initial status value
            serviceTitle: "Web Development Service", // Initial title value
            description: "We offer professional web development services", // Initial description
            gstCode: "GST123456", // Initial GST Code
            serviceCategory: "Web Development", // Initial service category
            serviceSubCategory: "Fullstack", // Initial service subcategory
            certificateFileName: "certificate.pdf", // Initial certificate file name
            licenseFileName: "license.pdf", // Initial license file name
            leadBalance: 10, // Initial lead balance
            terms: true, // Initial terms acceptance
            mediaFiles: [], // Initial media files
          }}
        ...
        >
          {({ setFieldValue, values, handleSubmit }) => (
            ...
            >
              <div className="w-[272px] mt-1 mb-4">
                <Field
                  as="select"
                  name="status"
                  className="w-full p-2 text-center bg-[#1D1F2A] text-white rounded-md shadow-md mb-1 border border-white"
                  style={{ textAlign: "center" }} // Center align text inside the dropdown
                >
